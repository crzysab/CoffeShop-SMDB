      ...
      ?>
       <tr>
          ...
          <td class="action">
              ...
              <a href="gudang/proses_hapus.php?kode_gudang=<?php echo $row['kode_gudang']; ?>" onclick="return confirm('Anda yakin akan menghapus data ini?')"class='btn btn-danger'>Hapus</a>
          </td>
      </tr>
