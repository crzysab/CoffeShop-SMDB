      ...
      ?>
       <tr>
          ...
          <td class="action">
              ...
              <a href="peralatan/proses_hapus.php?id_barang=<?php echo $row['id_barang']; ?>" onclick="return confirm('Anda yakin akan menghapus data ini?')"class='btn btn-danger'>Hapus</a>
          </td>
      </tr>
