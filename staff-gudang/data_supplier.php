      ...
      ?>
       <tr>
          ...
          <td class="action">
              ...
              <a href="supplier/proses_hapus.php?id_supplier=<?php echo $row['id_supplier']; ?>" onclick="return confirm('Anda yakin akan menghapus data ini?')"class='btn btn-danger'>Hapus</a>
          </td>
      </tr>
