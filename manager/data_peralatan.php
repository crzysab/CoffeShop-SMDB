...
<div class="item">
    ...
    <div class="container">
	<h2><center>Peralatan</center></h2>
  <div class="card mt-5">
    <div class="card-header">
	 <center><a href="tambah_peralatan.php"class="btn btn-info">+ &nbsp; Tambah Peralatan</a><center>
    </div>
    <div class="card-body">
    ...
    <tbody>
      ...
      $query = "SELECT * FROM peralatan ORDER BY id_barang ASC";
      ...
      ?>
       <tr>
          ...
          <td class="action">
              <a href="edit_peralatan.php?id_barang=<?php echo $row['id_barang']; ?>"class="btn btn-info">Edit</a> 
              <a href="../assets/src/proses/peralatan/proses_hapus.php?id_barang=<?php echo $row['id_barang']; ?>" onclick="return confirm('Anda yakin akan menghapus data ini?')"class='btn btn-danger'>Hapus</a>
          </td>
      </tr>
