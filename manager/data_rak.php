...
<html>
  ...
  <div class="wrapper">
    ...
    <div class="container">
	<h2><center>Rak</center></h2>
  <div class="card mt-5">
    <div class="card-header">
	 <center><a href="tambah_rak.php"class="btn btn-info">+ &nbsp; Tambah Rak</a><center>
    </div>
    <div class="card-body">
    ...
    <tbody>
      ...
      ?>
       <tr>
          ...
          <td class="action">
              <a href="edit_rak.php?kode_rak=<?php echo $row['kode_rak']; ?>"class="btn btn-info">Edit</a> 
              <a href="../assets/src/proses/rak/proses_hapus.php?kode_rak=<?php echo $row['kode_rak']; ?>" onclick="return confirm('Anda yakin akan menghapus data ini?')"class='btn btn-danger'>Hapus</a>
          </td>
      </tr>
