  ...
  <div class="wrapper">
    ...
    <div class="produk">
      <center>
        <h1>Tambah Gudang</h1>
      <center>
      <form method="POST" action="../assets/src/proses/gudang/proses_tambah.php" enctype="multipart/form-data" >
      <section class="base">
        <div>
          <label>Kode Gudang</label>
          <input type="text" name="kode_gudang" autofocus="" required="" />
        </div>  
          ...
          <select name="id_staff">
            ...
            <?php
              ...
              foreach($result as $data) {
                  echo"<option value='".$data['id_staff']."'>".$data['nama_staff']."</option>";                                  
                                                    }    
              ?>
            </select>
        </div>
