...
<html>
  ...
  <div class="card mt-5">
    <div class="card-header">
	  <center><a href="tambah_kopi.php"class="btn btn-info">+ &nbsp; Tambah Kopi</a><center>
    </div>
    <div class="card-body">
      ...
      ?>
       <tr>
          ...
          <td class="action">
              <a href="edit_kopi.php?id_kopi=<?php echo $row['id_kopi']; ?>"class="btn btn-info">Edit</a> 
              <a href="../assets/src/proses/kopi/proses_hapus.php?id_kopi=<?php echo $row['id_kopi']; ?>" onclick="return confirm('Anda yakin akan menghapus data ini?')"class='btn btn-danger'>Hapus</a>
          </td>
      </tr>
