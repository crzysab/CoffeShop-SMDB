...
<html>
  ...
  <div class="card mt-5">
    <div class="card-header">
	 <center><a href="tambah_supplier.php"class="btn btn-info">+ &nbsp; Tambah Supplier</a><center>
    </div>
    <div class="card-body">
    ...
    <tbody>
      ...
      ?>
       <tr>
          ...
          <td class="action">
              <a href="edit_supplier.php?id_supplier=<?php echo $row['id_supplier']; ?>"class="btn btn-info">Edit</a> 
              <a href="../assets/src/proses/supplier/proses_hapus.php?id_supplier=<?php echo $row['id_supplier']; ?>" onclick="return confirm('Anda yakin akan menghapus data ini?')"class='btn btn-danger'>Hapus</a>
          </td>
      </tr>
